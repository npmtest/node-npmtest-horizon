...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-horizon/node_modules/horizon/src/main.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-horizon/node_modules/horizon/src/main.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">92.5% <small>(37 / 40)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-horizon/node_modules/horizon/src/</a> &#187; main.js</div>
</div>
<div class="body">
...
<span class="missing-if-branch" title="else path not taken" >E</span>if (allArgs.length === 0) {
  help();
  process.exit(1);
}
&nbsp;
...
&nbsp;
<span class="missing-if-branch" title="if path not taken" >I</span>if (cmdName === '-h' || cmdName === '--help' || cmdName === 'help') {
...
<span class="missing-if-branch" title="else path not taken" >E</span>if (!command) {
...
<span class="branch-0 cbranch-no" title="branch not covered" >            err.niceString({ contextSize: 2 }) </span>: err.message;
...
&nbsp;
try {
  command.run(cmdArgs).then(() =&gt; <span class="cstat-no" title="statement not covered" >done())</span>.catch(done);
} catch (err) {
  done(err);
}
&nbsp;
